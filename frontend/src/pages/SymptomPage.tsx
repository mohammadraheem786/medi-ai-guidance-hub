...
const GROQ_API_KEY = "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";
...
const SymptomForm = ({ onAnalysisComplete, useAI = false }: SymptomFormProps) => {
  ...
  // Groq LLM AI call with robust JSON repair and fallback for markdown/code blocks
...
NO explanations. NO markdown, NO code block, ONLY plain valid JSON object.
`;
    ...
    // Extract only the first JSON object, even if there is text before/after
